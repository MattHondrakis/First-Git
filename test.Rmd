...
ggplot(stest, aes(`math`, color = `gender`)) +
  geom_density() + theme_classic()
ggplot(stest, aes(y = `math`, color = `gender`)) +
...
```{r fig.show = "hold", message=FALSE, warning=FALSE}
ggplot(stest, aes(`writing`, color = `gender`)) +
  geom_density() + theme_classic()
ggplot(stest, aes(y = `writing`, color = `gender`)) +
  geom_boxplot() + theme_classic() + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank())
```
...
ggplot(stest, aes(`math`, color = `race/ethnicity`)) +
  geom_density() + theme_classic()
ggplot(stest, aes(y = `math`, color = `race/ethnicity`)) +
  geom_boxplot() + theme_classic() + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank())
```
...
```{r fig.show = "hold", message=FALSE, warning=FALSE}
ggplot(stest, aes(`writing`, color = `race/ethnicity`)) +
  geom_density() + theme_classic()
ggplot(stest, aes(y = `writing`, color = `race/ethnicity`)) +
  geom_boxplot() + theme_classic() + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank())
```
...
```{r fig.show = "hold", message=FALSE, warning=FALSE}
ggplot(stest, aes(`math`, color = `parent ed`)) +
  geom_density() + theme_classic()
ggplot(stest, aes(y = `math`, color = `parent ed`)) +
  geom_boxplot() + theme_classic() + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank())
```
...
```{r fig.show = "hold", message=FALSE, warning=FALSE}
plott <- ggplot(stest, aes(`writing`, color = `parent ed`)) + theme_classic()
plott + geom_density()
plott + geom_boxplot() + theme(axis.ticks.y = element_blank(), axis.text.y = element_blank()) + labs(x = "")
```
